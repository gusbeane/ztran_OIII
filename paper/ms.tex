...
one might consider using to measure \zst{}. This is because computing \zst{}
from our simulations with our simple line intensity model
(\S~\ref{ssec:oiii_int_map}) does not require specifying the total average
