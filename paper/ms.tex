...
In detail $N_{\Ha}$ will have a frequency-dependent structure, but for
$z\sim9$ to $10$, it is reasonable to assume a conservative, constant value of
$N_{\Ha}\sim4\times10^4\,\text{Jy}/\text{sr}$ for the medium survey. For
